...
{
	"resource/Xmodel/DefaultPlayer/PlayerAnimation.x"
};
...
public:
	...
	*/
	...
	void Draw(LPD3DXEFFECT effect, UINT pass, LPD3DXMATRIX matrix);
	...
	*/
	...
	void DrawFrame(LPD3DXEFFECT effect, UINT pass, LPD3DXFRAME frame);
	...
	*/
	...
	void DrawMeshContainer(LPD3DXEFFECT effect, UINT pass, LPD3DXFRAME frame, LPD3DXMESHCONTAINER container);
	...
	*/
	...
	//アニメーション1回分の時間を取得
	float GetAnimationTime() { return m_MontageTime; }
